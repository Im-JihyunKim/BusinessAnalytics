...
__Definition of Anomaly(Novel Data)__
...
이번 튜토리얼은 'Anomaly Detection(이상치 탐지)'에 대한 주제로 진행하려 합니다. 그렇다면 이상치(Anomaly, Novel Data)란 무엇일까요? 이는 2가지 관점에서 정의할 수 있습니다.   
1. __데이터 생성 메커니즘__ 에서의 관점: 
